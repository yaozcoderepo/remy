...
ConfigRange::ConfigRange(void) : link_ppt(Range()),
                                 rtt(Range()),
...
ConfigRange::ConfigRange(RemyBuffers::ConfigRange input_config) : link_ppt(Range(input_config.link_packets_per_ms())),
