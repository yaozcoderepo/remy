...
public:
    MemoryRange(const Memory &s_lower, const Memory &s_upper,
                // std::vector< Axis > s_active = { RemyBuffers::MemoryRange::SEND_EWMA, RemyBuffers::MemoryRange::REC_EWMA, RemyBuffers::MemoryRange::RTT_RATIO, RemyBuffers::MemoryRange::SLOW_REC_EWMA, RemyBuffers::MemoryRange::MIN_RTT, RemyBuffers::MemoryRange::SLOW_REC_SEND_EWMA }
                std::vector<Axis> s_active = {RemyBuffers::MemoryRange::SEND_EWMA, RemyBuffers::MemoryRange::REC_EWMA, RemyBuffers::MemoryRange::RTT_RATIO, RemyBuffers::MemoryRange::SLOW_REC_EWMA, RemyBuffers::MemoryRange::SLOW_REC_SEND_EWMA})
